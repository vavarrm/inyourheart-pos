                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" id="exampleInputLastName"
                                                           type="text" placeholder="Code" name="t_proID" required
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <input class="form-control" type="number" name="t_proQTY"
                                                           placeholder="00" required  value="<?php echo $list->t_proQTY ?>" >
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="exampleConfirmPassword">Alert Quantity</label>
                                                    <input class="form-control" type="number" name="t_proQtyAlert"
                                                           placeholder="00" required value="<?php echo $list->t_proQtyAlert ?>"  >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" type="text" name="t_proCost"
                                                           placeholder="00" required value="<?php echo $list->t_proCost ?>" >
                                                </div>
                                                <div class="col-md-4">
                                                    <label for="exampleConfirmPassword">Price</label>
                                                    <input class="form-control" type="text" name="t_proPrice"
                                                           placeholder="00" required value="<?php echo $list->t_proPrice ?>" >
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="t_proDes">
                                                        <?php echo $list->t_proDes ?>
                                                    </textarea>
                                                </div>
